...
import { Loader2, Github, Mail, ArrowLeft, Clock, Info } from 'lucide-react'
...
function SignIn() {
  ...
  const handleSendOtp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Check your email for the OTP code or magic link')
        ...
        <CardContent className='grid gap-4'>
          ...
          >
              ...
              <>
                ...
                >
                  ...
                  {useMagicLink
                    ...
                    : 'Use magic link from email instead'}
                </Button>
                {useMagicLink && (
                  <div className='rounded-md bg-muted p-3 text-sm'>
                    <p className='mb-2 font-medium'>
                      How to sign in with magic link:
                    </p>
                    <ol className='list-inside list-decimal space-y-1 text-muted-foreground'>
                      <li>Check your email for a sign-in link</li>
            ...
            <Button type='submit' disabled={isLoading} className='w-full'>
              ...
              {showOtpInput ? 'Verify & Sign In' : 'Send OTP Code'}
            </Button>
            {showOtpInput && (
              <Button
                type='button'
