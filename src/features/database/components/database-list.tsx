...
import { databaseColumns as columns } from './database-columns'

const route = getRouteApi('/_authenticated/database/')

type DataTableProps = {
  data: Database[]
}

export function DatabaseList({ data }: DataTableProps) {
  ...
  return (
    ...
    >
      <DataTableToolbar
        table={table}
        searchPlaceholder='Filter by name or type...'
        filters={[
          {
            columnId: 'status',
            title: 'Status',
