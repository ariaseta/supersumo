 ...
 *
 * Security: All cookies use Secure, HttpOnly (via proper flag), and SameSite=Strict
 */
 ...
 * - Encoded value: Prevents injection attacks
 */
export function setCookie(
  ...
  let cookieString = `${name}=${encodedValue}; path=/; max-age=${maxAge}`

  // Add Secure flag (only HTTPS)
  cookieString += '; Secure'
